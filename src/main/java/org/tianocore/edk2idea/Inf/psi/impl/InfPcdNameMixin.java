...
public abstract class InfPcdNameMixin extends ASTWrapperPsiElement implements PsiNameIdentifierOwner {
    public InfPcdNameMixin(@NotNull ASTNode node) {
        super(node);
    }
